...
namespace App.App_XamlTypeInfo
{
    ...
    internal partial class XamlTypeInfoProvider
    {
        ...
        private void InitTypeTables()
        {
            ...
            _typeNameTable[0] = "App.ViewModels.MainViewModel";
            _typeNameTable[1] = "MvvmAtom.AtomViewModelBase";
            _typeNameTable[2] = "Object";
            _typeNameTable[3] = "String";
            _typeNameTable[4] = "MvvmAtom.AtomCommandBase";
            _typeNameTable[5] = "App.MainPage";
            _typeNameTable[6] = "Windows.UI.Xaml.Controls.Page";
            _typeNameTable[7] = "Windows.UI.Xaml.Controls.UserControl";

            _typeTable = new global::System.Type[8];
            _typeTable[0] = typeof(global::App.ViewModels.MainViewModel);
            _typeTable[1] = typeof(global::MvvmAtom.AtomViewModelBase);
            _typeTable[2] = typeof(global::System.Object);
            _typeTable[3] = typeof(global::System.String);
            _typeTable[4] = typeof(global::MvvmAtom.AtomCommandBase);
            _typeTable[5] = typeof(global::App.MainPage);
        ...
        private object Activate_0_MainViewModel() { return new global::App.ViewModels.MainViewModel(); }
        private object Activate_5_MainPage() { return new global::App.MainPage(); }
        ...
        private object get_0_MainViewModel_DeviceName(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.DeviceName;
        }
        private void set_0_MainViewModel_DeviceName(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.DeviceName = (global::System.String)Value;
        }
        private object get_1_MainViewModel_DeviceIP(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.DeviceIP;
        }
        private void set_1_MainViewModel_DeviceIP(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.DeviceIP = (global::System.String)Value;
        }
        private object get_2_MainViewModel_Status(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.Status;
        }
        private void set_2_MainViewModel_Status(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.Status = (global::System.String)Value;
        }
        private object get_3_MainViewModel_LastChecked(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.LastChecked;
        }
        private void set_3_MainViewModel_LastChecked(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.LastChecked = (global::System.String)Value;
        }
        private object get_4_MainViewModel_CheckDoor(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.CheckDoor;
        }
        private void set_4_MainViewModel_CheckDoor(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.CheckDoor = (global::MvvmAtom.AtomCommandBase)Value;
        }
        private object get_5_MainViewModel_SetupHub(object instance)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            return that.SetupHub;
        }
        private void set_5_MainViewModel_SetupHub(object instance, object Value)
        {
            var that = (global::App.ViewModels.MainViewModel)instance;
            that.SetupHub = (global::MvvmAtom.AtomCommandBase)Value;
        }
